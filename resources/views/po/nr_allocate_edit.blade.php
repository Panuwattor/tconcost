...
<div class="row" id="app" v-cloak>
    ...
    <div class="col-12 col-md-7">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/nr-allocate/update" method="post">
                    @csrf
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row mb-3">
                                            <div class="col-6"></div>
                                            <div class="col-6">
                                                <input type="text" v-model="search_value" class="form-control form-control-sm" placeholder="Search" @keyup="search">
                                            </div>
                                        </div>
...
<script>
    var app = new Vue({
        ...
        created() {
            for (var i = 0; i < this.allocate_list.length; i++) {
                this.arr.push({
                    project: this.allocate_list[i].project_id,
                    cost_group: this.allocate_list[i].cost_plan_name + '/' + this.allocate_list[i].costPlanLists,
                    cost_group_id: this.allocate_list[i].project_cost_plan_list_id,
                    price: this.allocate_list[i].price,
                });
            }
        ...
        methods: {
            ...
            onselect_project: async function(index) {
                ...
                this.project_id = document.getElementById('project_id' + index).value;
