...
<form id="app" v-cloak action="/po-nr/update" method="post" enctype="multipart/form-data" onsubmit="return confirm('ยืนยันแก้ไขการสั่งซื้อ ข้อมูลขอซื้อถูกต้อง ?')">
    @csrf
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input readonly type="text" class="form-control form-control-sm" value="{{$po->project->name}}">
                            <input readonly type="hidden" name="project_id" class="form-control form-control-sm" value="{{$po->project->id}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label">ผู้ขาย <span class="text-danger"><b>*</b></span></label>
                        <div class="col-sm-8">
                            <input readonly type="text" class="form-control form-control-sm" value="{{$po->supplier->name}}">
                            <input readonly type="hidden" name="supplier_id" class="form-control form-control-sm" value="{{$po->supplier->id}}">
                        </div>
                    </div>
                    @if($po->contract)
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input readonly type="text" class="form-control form-control-sm" value="{{$po->contract->name}}">
                            <input readonly type="hidden" name="contract_id" class="form-control form-control-sm" value="{{$po->contract->id}}">
                        </div>
                    </div>
                    @endif
                    <div class="form-group row">
    ...
    <div class="card">
        ...
        <div class="card-body row">
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in arr">
                            ...
                            <td>
                                <input v-model="item.vat" readonly required type="text" name="vat[]" id="vat" class="form-control form-control-sm" placeholder="vat">
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="col-12 col-md-4">
                <br>
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">รวมเป็นเงิน</label>
                    <div class="col-sm-8">
                ...
                <!-- <div class="form-group row">
                    <label class="col-sm-4 col-form-label">ส่วนลดพิเศษ</label>
                    <div class="col-sm-8">
