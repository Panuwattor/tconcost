    ...
    <div class="col-12 col-md-6">
        <div class="card">
            <div class="card-header">
                <!-- <a target="_bank" href="/po/print/{{$po->id}}"><span style="color: #007bff; cursor: pointer;"><i class="fa fa-print"></i> ปริ้น ใบสั่งซื้อ</span></a> -->
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    @if(!$list->allocate)
                                    <a href="/po-nr/allocate/{{$list->id}}"><button type="button" class="btn btn-outline-info btn-sm w-auto">จัดสรรต้นทุน</button></a>
                                    @else
                                    ...
                                    @if($po->status != 2)
                                    <a href="/po-nr/allocate/edit/{{$list->id}}"><button type="button" class="btn btn-outline-warning btn-sm w-auto">แก้ไข</button></a>
                                    @endif
                                    @endif
                                </td>
                                @endif
