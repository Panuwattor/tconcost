...
<form id="app" v-cloak action="/po/reject/update/{{$po->id}}" method="post" enctype="multipart/form-data" onsubmit="return confirm('ยืนยันขออนุมัติใหม่ ข้อมูลขอซื้อถูกต้อง ?')">
    @csrf
        ...
        methods: {
            ...
            cal(){
                ...
                for(var i = 0; i < this.arr.length; i++){
                    ...
                    this.total_price = (parseFloat(this.total_price) + parseFloat(this.arr[i].price)).toFixed(2);
                    this.sum_price = (parseFloat(this.sum_price) + parseFloat(this.arr[i].price)).toFixed(2);
                }
