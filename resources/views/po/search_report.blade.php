...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Search Purchase Order</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item active">Search Purchase Order</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="card">
    <div class="card-body">
    <form action="/po/search_report" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
                    ...
                    <a href="/po/create/PO">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">สร้าง PO</span>
