    ...
    <div class="card-body table-responsive">
        <table id="example1" class="table table-hover text-nowrap">
            ...
            <tbody>
                @foreach($pos as $i => $po)
                <tr class="text-center">
                    <td>@if( $po->notify ) <i class="fa fa-check-circle-o text-success pull-left"></i> @else  <a href="/po/approve/click/notify/{{$po->id}}"><i class="fa fa-exclamation-circle text-warning pull-left"></i></a>  @endif {{$i+1}}</td>
