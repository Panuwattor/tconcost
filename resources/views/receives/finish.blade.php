...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">รายการรับของ เสร็จสิ้น</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item active">รายการรับของ เสร็จสิ้น</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">รายการรับของ เสร็จสิ้น</h3>
    </div>
    <!-- /.card-header -->
