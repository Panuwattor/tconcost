    ...
    <div class="card-body table-responsive">
        ...
        <table class="table table-hover text-nowrap">
            ...
            <tbody>
                <tr v-for="(item, index) in po_list" class="text-center">
                    ...
                    <td style="width: 10%;">
                        <input type="number" readonly v-model="item.amount" @change="cal_price" class="form-control form-control-sm" step="any">
                    </td>
                    <td>@{{item.unit}}</td>
                    ...
                    <td style="width: 20%;">
                        <input type="number" readonly v-model="item.price" @change="price_change(index)" class="form-control form-control-sm" step="any">
                    </td>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 text-right">
                ...
                @if($type == 'PAD')
                <div class="form-group">
                    <span>RETENTION : <input style="text-align: right;" type="text" readonly value="0" v-model="retention" @change="cal_price"></span>
                </div>
                @endif
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-12">
                <button id="btn_submit" @click="submit()" type="button" class="w-auto btn btn-block btn-outline-danger btn-sm float-right">ยกเลิกการรับของ</button>
...
<script>
    ...
    var app = new Vue({
        ...
        data() {
            return {
                ...
                receive: {
                    ...
                    note: '',
                    supplier_id: 'เลือก',
                    payment_condition: 'จ่ายทันที',
                },
                price: {
                    sum_price: 0,
                    vat_amount: 0,
                    sum: 0,
                    special_discount: '{{$po->special_discount - $po->receive_special_discount}}',
                    receive_special_discount: '{{$po->receive_special_discount}}',
                },
                arr1: new Array(),
                duedate: {
        ...
        mounted() {
            ...
            for(var xx = 0; xx < this.po_list_real.length; xx++){
                if(this.po_list_real[xx].amount - this.po_list_real[xx].received > 0){
                    this.po_list.push(this.po_list_real[xx]); 
                }
            }
