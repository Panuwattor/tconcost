...
<div class="card" id="app" v-cloak>
    ...
    <div class="card-body table-responsive">
        ...
        <table class="table table-hover text-nowrap">
            ...
            <tbody>
                <template v-for="(item, index) in po_list">
                    <tr class="text-center">
                        <!-- <td>@{{index + 1}}</td> -->
                    ...
                    <tr v-for="(list_note, list_note_index) in item.list_notes" class="text-center" style="background-color: #ddd;">
                        <td></td>
                        <td colspan="6">@{{list_note.note}}</td>
                        <td></td>
                    </tr>
                </template>
            </tbody>
        ...
        methods: {
            ...
            submit: async function() {
                ...
                if (confirm('ยืนยันการรับของ ?')) {
                    ...
                    var res = await axios.post('/receive', {
