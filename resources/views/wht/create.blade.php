...
<div class="card" id="app">
    ...
    <div class="card-body table-responsive">
        <form action="/wht/create" method="post">
            @csrf
            <div class="row">
                ...
                <div class="col-12 col-md-3 ">
                    <div class="form-group">
                        <label>ประเภท</label>  
                        <select name="type" id="tax_type" class="form-control form-control-sm  ">
                            <option value="ภ.ง.ด53">หัก ภ.ง.ด53</option>
                            <option value="ภ.ง.ด3">ภ.ง.ด3</option>
                        </select>           
                    </div>
                </div>
                <div class="col-12 col-md-3">
                    <div class="form-group">
                        ...
                        <select name="wht_payment_type" id="wht_payment_type" class="form-control form-control-sm select2">
                            ...
                            <option value="ออกตลอด">ออกตลอด</option>
                            <option value="ออกครั้ง1">ออกครั้ง1</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-md-3">
                    <div class="form-group">
                        <label>วันที่</label>
                        <input required type="text" readonly autocomplete="off" name="date" class="form-control form-control-sm" id="date" value="{{\Carbon\Carbon::today()->format('Y-m-d')}}">
                    </div>
                </div>
                <div class="col-12 col-md-3">
                    <div class="form-group">
                        <label>ชื่อ</label>
                        <input required type="text" autocomplete="off" name="name" id="name" class="form-control form-control-sm">
                    </div>
                </div>
                <div class="col-12 col-md-3">
                    <div class="form-group">
                        <label>Tax Id</label>
                        <input required type="text" autocomplete="off" name="tax_id" id="tax_id" maxlength="13" minlength="13" class="form-control form-control-sm">
                    </div>
                </div>
                <div class="col-12 col-md-3">
                    <div class="form-group">
                        <label>Address</label>
                        <input required type="text" autocomplete="off" name="address" id="address" class="form-control form-control-sm">
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <label class="form-check-label"><input class="form-check-input" type="radio" name="attribute" v-model="attribute" value="ยื่นปกติ" checked> ยื่นปกติ</label>
                            </div>
                            <div class="form-check">
                            <label class="form-check-label"><input class="form-check-input" type="radio" name="attribute" v-model="attribute" value="ยื่นเพิ่มเติม ครั้งที่">ยื่นเพิ่มเติม ครั้งที่</label>
                                
                            </div>
                            <input type="text" autocomplete="off" name="attribute_count" id="attribute_count" class="form-control form-control-sm">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-3">
...
<script>
    ...
    $(function(){
      ...
      async function getSupplier()
      {
          ...
          console.log(sup.tax_type)
          if(sup.tax_type){
            document.getElementById('tax_type').value = sup.tax_type;
          }
