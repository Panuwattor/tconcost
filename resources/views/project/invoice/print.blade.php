...
<body lang=EN-US style='tab-interval:.5in'>
    <page size="A4" style="padding: 20px;">
                    ...
                    <table style="width: 100%; text-align: right;" class="purchase-background">
                        <tr>
                            <td style="width: 100%; text-align: center; padding: 15px;">
                                <span class="subsubject"><b>ใบแจ้งหนี้</b></span><br>
            ...
            <tr>
                ...
                <td style="width: 40%; text-align: right;" class="card-solid">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td style="width: 60%; padding: 5px;">
                                <span class="contents"><b>กำหนดรับชำระ(DueDate)</b></span><br>
                            </td>
        ...
        <table style="width: 100%; margin-top: 5px; border-radius: 10px!important;">
            ...
            @endforeach   
                <tr>
                    <td style="padding-top: 5px;" colspan="2" rowspan="5" class="top"><span class="foot_contents"> <b>หมายเหตุ (Remarks) : </b> {{$invoice->note}}</span></td>
                    <td style="padding-top: 5px;" colspan="2"><span class="contents">มูลค่ารวม (Total)</span></td>
                ...
                <tr>
                    <td style="padding-top: 5px;" colspan="2"><span class="contents">ส่วนลด (Discount)</span></td>
                    <td style="padding-top: 5px; text-align: right; padding-right: 5px;"><span class="contents">{{number_format($invoice->discount,2)}}</span></td>
                </tr>
                <tr>
                    <td style="padding-top: 5px;" colspan="2"><span class="contents">มูลค่าคงเหลือ (Taxbase)</span></td>
        ...
        <table style="width: 100%; margin-top: 20px;">
            <tr>
                ...
                <table style="width: 100%; margin-top: 2px;">
                        <tr class="card-solid">
                        <th style="padding-top: 10px; padding: 10px;" class="text-center"></b><span class="foot_contents"></br></br></br>ผู้รับวางบิล</span></b></th>
                        </tr>
                </table>
                </td>
                <td style="width: 30%; text-align: center;">
                <table style="width: 100%; margin-top: 2px;">
                        <tr class="card-solid">
                        <th style="padding-top: 10px; padding: 10px;" class="text-center"></b><span class="foot_contents"></br></br></br>ผู้วางบิล</span></b></th>
                        </tr>
                </table>
                </td>
