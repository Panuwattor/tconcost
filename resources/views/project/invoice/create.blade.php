...
<div class="container-fluid">
    <form action="/project/invoice/store/{{$project->id}}" method="post">
        @csrf
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <br><input  class="text-center form-control" type="date" name="date" autocomplete="off" value="{{\Carbon\Carbon::today()->format('Y-m-d')}}">
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive p-0">
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    $retention = 0;
                                    ?>
                                    @foreach($incomes as $i => $interim_list)
                                    <?php
                                    ...
                                    ?>
                                    <input type="hidden" name="incomes[]" value="{{$interim_list->id}}">
                                    <tr class="text-center">
                                        <td>{{$i + 1}}</td>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="customRadio1" value="เงินสด" name="payment_condition" checked="" @click="onselect_payment()">
                                        ...
                                        <div class="custom-control custom-radio" style="margin-top: 10px;">
                                            <input class="custom-control-input" type="radio" id="customRadio2" value="เครดิต" name="payment_condition" @click="onselect_payment()">
                            ...
                            <div class="col-12 col-md-5">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">
                                        <label>VAT</label> (@{{vat_type}})
                                        <select style="display: none;" name="vat_type" v-model="vat_type" @change="cal()" id="vat_type" class="form-control form-control-sm">
